...
public class DragAndClickHandler implements EventHandler<MouseEvent> {
    ...
    public DragAndClickHandler(EventHandler<MouseEvent> onDraggedEventHandler, EventHandler<MouseEvent> onClickedEventHandler) {
